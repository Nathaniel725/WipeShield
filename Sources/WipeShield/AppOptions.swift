...
enum AppOptions {
    ...
    static let bundleID = Bundle.main.bundleIdentifier ?? "com.wipeshield.mac"
...
func logError(_ message: String) {
    ...
    if AppOptions.selfTestSeconds != nil {
        FileHandle.standardError.write(Data("[WipeShield][ERROR] \(message)\n".utf8))
    }
}
